...
COMMENT ON CONSTRAINT credit_purchases_stripe_fields_check ON credit_purchases IS 'Ensures Stripe fields are required for Stripe payments and tx_hash is required for USDC payments';
